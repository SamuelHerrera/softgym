...
public class OUT_Efectivo extends javax.swing.JInternalFrame {
    ...
    public void SalidaEfectivo(){
        String motivo=null;
        if(jTextField1.equals("")||jTextArea1.equals("")){
            JOptionPane.showMessageDialog(null,"Debes de llenar todos los campos");
        }
        else{
            if(jRadioButton1.isSelected()){motivo=jRadioButton1.getText();}
            if(jRadioButton2.isSelected()){motivo=jRadioButton2.getText();}
            if(jRadioButton3.isSelected()){motivo=jRadioButton3.getText();}
            
            usadb db= new usadb();
            db.in_egreso(new Date(), motivo, jTextArea1.getText(), Double.parseDouble(jTextField1.getText()), SoftGym.nombre);//Falta agregar usuario
            JOptionPane.showMessageDialog(null, "Salida agregada efectivamente");
            dispose();
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jRadioButton1.setBackground(SoftGym.fondo);
        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setFont(new java.awt.Font("Agency FB", 1, 14)); // NOI18N
        jRadioButton1.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton1.setText("Sueldos");

        jRadioButton2.setBackground(SoftGym.fondo);
        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Agency FB", 1, 14)); // NOI18N
        jRadioButton2.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton2.setText("Pagos de servicios");

        jRadioButton3.setBackground(SoftGym.fondo);
        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setFont(new java.awt.Font("Agency FB", 1, 14)); // NOI18N
